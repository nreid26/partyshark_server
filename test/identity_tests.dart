...
int main() {
  test('Identity defines equality on identifiables', () {
  ...
  test('Identity defines hashcodes on identifiables', () {
    final ConcreteIdentifiable
      a = new ConcreteIdentifiable(0, 0),
      b = new ConcreteIdentifiable(0, 1);
  ...
  test('Identifiables have their identity in their toString() representation', () {
